MODULE Module1
    ...
    CONST robtarget get_valde_A_10:=[[134.165999362,6.474813313,146.736968531],[0.709438415,-0.028403008,-0.704170494,-0.005858381],[0,1,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget get_valde_A_20:=[[-6.506399876,13.312730858,147.676785261],[0.709437918,-0.02840299,-0.704170997,-0.005858143],[0,1,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget get_valde_A_30:=[[0.538993714,2.07837324,175.552068649],[0.70943806,-0.028403001,-0.704170853,-0.00585818],[0,1,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget get_valde_A_40:=[[1.038117986,4.003003563,236.25567197],[0.709438053,-0.028403001,-0.704170861,-0.005858128],[0,1,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget get_valde_A_50:=[[-13.255288018,-291.349215412,245.737698955],[0.709438047,-0.028403007,-0.704170866,-0.005858129],[0,1,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
 
    CONST robtarget get_valde_B_70:=[[30.743184262,8.324993523,479.671893117],[0.70943806,-0.028403015,-0.704170853,-0.005858135],[-1,0,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget get_valde_B_80:=[[0.315192857,-58.869691992,134.245092553],[0.709438496,-0.028403127,-0.70417041,-0.005858029],[-1,0,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    CONST robtarget get_valde_B_90:=[[69.613864015,-62.238242507,133.781975781],[0.70943849,-0.028403122,-0.704170417,-0.005858011],[-1,0,2,0],[9E+09,9E+09,9E+09,9E+09,9E+09,9E+09]];
    ...
    PROC get_valde()
    	...
    	MoveL get_valde_A_10,v1000,z100,gancho\WObj:=Banda_Tr;
    	MoveL get_valde_A_20,v1000,z100,gancho\WObj:=Banda_Tr;
    	MoveL get_valde_A_30,v1000,z100,gancho\WObj:=Banda_Tr;
    	MoveL get_valde_A_40,v1000,z100,gancho\WObj:=Banda_Tr;
    	MoveL get_valde_A_50,v1000,z100,gancho\WObj:=Banda_Tr;
        
		MoveL get_valde_B_70,v1000,z100,gancho\WObj:=valde_en_suelo;
        MoveL get_valde_B_80,v1000,z100,gancho\WObj:=valde_en_suelo;
        MoveL get_valde_B_90,v1000,z100,gancho\WObj:=valde_en_suelo;   
    ENDPROC
    PROC put_valde()
